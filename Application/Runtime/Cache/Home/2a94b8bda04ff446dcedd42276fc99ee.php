...
<div class="container content">
    ...
    <div id="" class="view row" style="margin-top:30px;">
        ...
        <div class="span12 margin-bottom-20" style="text-align:center;">
            <div class="spinner" >
                <a href="http://www.anumbrella.net/App/AppShopService/Uploads/App/洛克商城.apk"  id="down_load"  class="btn-u btn-u-lg"><i class="fa fa-download"></i> 点击下载</a>
            </div>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="word-break:break-all;">
            <div class="tag-box tag-box-v6">
                <h2>应用介绍</h2>
                洛克商城 开源版 是一款包括用户注册、登录、密码找回、短信验证、用户分享、消息推送、订单上传、商品分类、商品收藏、购物车订单的增添、删除、商品查询、用户设置、用户评价、用户评论等基本功能的app。 </div>
        </div>
    </div>
