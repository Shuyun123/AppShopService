...
<div style="display:none;">
    <img src="/AppShopService/Public/Img/Home/ic_launcher.png" onerror="javascript:this.src='http://o1wjx1evz.qnssl.com/static-20160507/assets/img/default-icon.png';" />
</div>
<!--=== Breadcrumbs ===-->
<div class="row-fluid breadcrumbs margin-bottom-20" style="background: rgb(73, 80, 95);margin-top: -2px">
    <div class="container">
        <h1 class="pull-left" style="color: #ffffff;">洛克商城</h1>
        <ul class="pull-right breadcrumb">
            <li ><a href="https://github.com/Shuyun123/LKShop" target="_blank" style="margin-right: 10px;">获取源码</a></li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
...
<div class="container content">
    ...
    <div id="" class="view row" style="margin-top:30px;">
        ...
        <div class="span12 margin-bottom-20" style="text-align:center;">
            <div class="spinner" >
                <a href="http://www.anumbrella.net/App/AppShopService/Uploads/App/洛克商城.apk"  id="down_load"  class="btn-u btn-u-lg"><i class="fa fa-download"></i> 点击安装</a>
            </div>

        </div>

        <div class="span12" style="text-align:center;">
            <span class="label label-success">适用于Android设备</span>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="word-break:break-all;">
            <div class="tag-box tag-box-v6">
                <h2>应用介绍</h2>
                洛克商城 开源版 是一款包括用户注册、登录、密码找回、短信验证、用户分享、消息推送、订单上传、商品分类、商品收藏、购物车订单的增添、删除、商品查询、用户设置、用户评价、用户评论等基本功能。            </div>
        </div>
    </div>
